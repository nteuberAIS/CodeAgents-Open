...
class Settings(BaseSettings):
    ...
    # -- Tool registry (empty for Phase 1) --
    # Future: {"git": "tools.git_tool.GitTool", "notion": "tools.notion_tool.NotionTool"}
    tool_registry: dict[str, str] = {}

    # -- Future config hooks (uncomment as needed) --
    # rag_retriever_path: str | None = None        # Path to local Notion mirror / vector DB
    # notion_api_key: str | None = None             # Notion integration token
